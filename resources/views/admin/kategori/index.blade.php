                    ...
                    <table class='table table-striped' id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="/admin/kategori/{{$item->id}}/edit" class="btn btn-info btn-sm"><i data-feather="edit"></i></a>
                                        <!--<a href="" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>-->
                                        <form action="/admin/kategori/{{$item->id}}" method="POST">
                                            @method('delete')
                                            @csrf
                                            <button type="submit" class="btn btn-danger btn-sm ml-1" id="delete"><i data-feather="trash"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
